            ...
            <div class="container">
                ...
                <div class="mt-6">
                    <div class="mt-6 buttons are-large">
                        <a class="has-text-white button is-outlined is-size-3 mr-4" style="background: #3298dc" href="#">Back</a>
                        <a class="has-text-white button is-outlined is-size-3 mr-4 ml-4" style="background: #ee7a00" href="#">Reload</a>
                        <a class="has-text-white button is-outlined is-size-3 ml-4" style="background: #3298dc" href="#">Home</a>
                    </div>
                </div>
            </div>
        </div>
